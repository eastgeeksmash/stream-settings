    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="mt-6 border-t pt-4">
        ...
        <p className="text-slate-600 mt-2">
          MIT Licenseの下で提供されており、無償で使用、複製、変更、配布することができます。詳細については<a href="https://github.com/eastgeeksmash/stream-settings/blob/main/LICENSE" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">ライセンス</a>をご確認ください。
        </p>
